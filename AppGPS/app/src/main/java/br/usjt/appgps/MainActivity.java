...
public class MainActivity extends AppCompatActivity {
    ...
    // Evita a chamada do método findViewById, que custa caro para o desempenho do sistema
    // Já deixa guardado os atalhos das views já carregas, para serem chamadas novamente, caso precise

    private class MeuViewHolder extends RecyclerView.ViewHolder{
        TextView latitudadeTextView;
        TextView longitudeTextView;
        public MeuViewHolder (View raiz){
            super(raiz);
            latitudadeTextView = raiz.findViewById(R.id.latitudeTextView);
    ...
    private class MeuAdapter extends RecyclerView.Adapter<MeuViewHolder>{
        ...
        public MeuViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
            ...
            View raiz = inflater.inflate(R.layout.list_icon, viewGroup, false);
            return null;
        }
        ...
        public void onBindViewHolder(@NonNull MeuViewHolder meuViewHolder, int i) {
            ...
            meuViewHolder.latitudadeTextView.setText(
    ...
    protected void onStart() {
        ...
        if(ActivityCompat.checkSelfPermission(
            ...
            locationManager.requestLocationUpdates(
                    //FILTRAR POR TEMPO E/OU DISTÂNCIA
